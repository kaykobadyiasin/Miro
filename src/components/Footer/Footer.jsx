    ...
    return (
        <div className="bg-[#02033B] text-white py-10">
            <div className="containerWidth mx-auto">
                <div className="flex lg:flex-row flex-col-reverse gap-8 xl:text-left text-center justify-between ">
                ...
                <div className='lg:w-[50%] lg:text-left text-center mt-10 text-sm'>
